...
<%@ attribute name="page" type="org.troy.common.utils.dwz.Page" required="true"%>
...
<div class="panelBar">
	<div class="pages">
		...
		<span style="margin-left: 5px;">总条数: ${page.totalCount}</span>
		<span style="color: red;margin-left: 10px;">${page.addContent}</span>
	</div>
