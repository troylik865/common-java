...
<div class="pageContent">
	<form method="post" action="${contextPath}/login" class="pageForm">
		<%-- 指定为ajax请求 --%>
		<input type="hidden" name="ajax" value="true"/>
		<div class="pageFormContent" layoutH="58">
			<p>
				<label>用户名:</label>
				<input type="text" name="username" id="username" style="width: 150px;" maxlength="20" class="required"/>
			</p>
			<p>
				<label>密&nbsp;&nbsp;&nbsp;&nbsp;码:</label>
				<input type="password" name="password" id="password" style="width: 150px;" maxlength="20" class="required"/>
			</p>
			<%-- <p>
				<label>验证码:</label>
