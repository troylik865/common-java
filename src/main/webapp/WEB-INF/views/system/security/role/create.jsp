...
<form method="post" action="${contextPath}/system/security/role/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<input type="hidden" name="moduleIds" id="moduleIds" value="" />
	<div class="pageFormContent" layoutH="100">
		<dl>
			<dt>名称：</dt>
			<dd>
				<input type="text" name="name" class="required" size="32" maxlength="32" alt="请输入角色名称"/>
			</dd>
		</dl>
		<dl>
			<dt>描述：</dt>
			<dd>
				<input type="text" name="description" size="32" maxlength="255" alt="请输入角色描述" />
			</dd>
		</dl>
