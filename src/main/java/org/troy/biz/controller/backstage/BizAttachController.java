 ...
 */
@Controller
@RequestMapping("/biz/backstage/attach")
public class BizAttachController extends ViewController {

    private static final String LIST   = "/biz/backstage/attach/list";

    private static final String CREATE = "biz/backstage/attach/attach";
    private static final String UPDATE = "biz/backstage/attach/update";
    ...
    public String preCreate(Map<String, Object> map, @PathVariable Long id) {
        map.put("bizId", id + "");
        map.put("type", HttpReceiver.getHttpServletReqeuest().getParameter("type"));
        return CREATE;
    }
